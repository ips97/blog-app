...
// p/ importar o models no mongoose
...
router.get("/categorias",eAdmin, (req, res)=>{
    // redireciona p/ a views categoria passando os objetos categorias do bd
...
router.post("/categorias/edit", eAdmin,  (req,res) => {
    ...
    Categoria.findOne({_id: req.body.id}).then((categoria) =>{
        ...
        categoria.save().then(() =>{
            ...
            req.flash("error_msg", "Houve um erro interno ao salvar a edião da categoria");
            res.redirect("/admin/categorias")
        });
    }).catch((err) =>{
...
router.get("/postagens", eAdmin, (req,res)=>{
    Postagem.find().populate("categoria").sort({data:"desc"}).then((postagens)=>{
        ...
        req.flash("error_msg", "Houve um erro ao listar as pontagens")
        res.redirect("/admin")
    })
...
router.get("/postagens/edit/:id", eAdmin, (req,res)=>{
    Postagem.findOne({_id: req.params.id}).then((postagem) =>{
        ...
        req.flash("err_msg", "Houve um erro ao carregar o formulário de edição")
        res.redirect("/admin/postagens");
    });
